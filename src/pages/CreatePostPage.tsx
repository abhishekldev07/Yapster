    ...
    <main className="pb-16 pt-7 max-[760px]:pb-8 max-[760px]:pt-4">
      <div className="mx-auto max-w-[760px] px-4 sm:px-6">
        <div className="mb-6 flex items-start gap-4">
          ...
          <div>
            <p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-violet-600">
              Create post
            </p>
            <h1 className="mt-1 text-3xl font-black tracking-[-0.045em] text-slate-950 sm:text-4xl">
              Start a conversation.
            </h1>
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Choose a community, give people a reason to click, and share something worth discussing.
            </p>
          </div>
        </div>
